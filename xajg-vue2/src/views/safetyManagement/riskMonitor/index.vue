    ...
    >
      ...
      <template slot="table">
        ...
        >
          ...
          <el-table-column label="潜在事故类型" prop="accidentTypes">
            <template slot-scope="{ row }">
              <!-- <el-tooltip :content="row.accidentTypes" placement="top" effect="dark"> -->
          ...
          >
            <template slot-scope="{ row }">
              <!-- <el-tooltip :content="row.responsiblePerson" placement="top" effect="dark"> -->
              <span class="text-ellipsis">
          ...
          >
            <template slot-scope="scoped">
              <span>
                {{ timeFormat(scoped.row.effectiveDateStart, "YYYY-MM-DD") }} ~
                {{ timeFormat(scoped.row.effectiveDateEnd, "YYYY-MM-DD") }}
              </span>
            </template>
          </el-table-column>
          <el-table-column
...
<script>
import { page, remove, BelongTo } from "./api";
