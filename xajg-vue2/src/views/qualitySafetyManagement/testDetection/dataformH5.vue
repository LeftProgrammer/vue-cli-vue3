      ...
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="报检信息" name="first">
          <el-row :gutter="20">
            ...
            <el-col :span="24" v-if="node.classification === 'wgcl'">
            ...
            <el-col :span="24" v-if="node.classification === 'zccl'">
...
export default {
  ...
  async created() {
    if (this.$route.query.fromappform === "1") {
      ...
      this.node = {};
      this.data = {};
      this.formData.id = this.$route.query.businessId || this.$route.query.Id;
      this.visible = true;
      this.readonly = true;
      this.appInitForm();
  ...
  methods: {
    ...
    async appInitForm() {
      console.log("appInitForm start......................")
      const params = {
        id: this.$route.query.businessId || this.$route.query.Id
      };
