              ...
              <el-row>
                <el-col :span="12">
                  <el-form-item label="附件上传" prop="unqualifiedFile">
                    ...
                    <!-- <el-upload
                      ref="unqualifiedFilesRef"
                      accept=".pdf,.docx,.doc"
                      multiple
                      :limit="10"
                      :file-list="formData.unqualifiedFiles || []"
              ...
              <el-row>
                <el-col :span="12">
                  <el-form-item label="检测报告" prop="uploadFile">
                    <uploadFile :readonly="true" v-model="formData.uploadFile" :limit="1"  :maxSize="200" accept=".pdf,.docx,.doc"></uploadFile>
                    <!-- <el-upload
                      ref="reportListRef"
                      accept=".pdf,.docx,.doc"
                      multiple
                      :limit="1"
                      :file-list="formData.reportList||[]"
                      action="/api/attachments/single-upload"
                      :disabled="true"
                      width="100%"
                    >
