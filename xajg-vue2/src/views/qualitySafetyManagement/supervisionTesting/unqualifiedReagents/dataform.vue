              ...
              <el-row>
                <el-col :span="12">
                  <el-form-item label="附件上传" prop="unqualifiedFile">
                    <uploadFile
                      :readonly="!enterAble"
                      v-model="formData.unqualifiedFile"
                      :maxSize="200"
                    ></uploadFile>
                  </el-form-item>
                </el-col>
                ...
                <el-col :span="12">
                  <el-form-item label="代表数量" prop="representativeQuantity">
                    <el-input
                      ...
                      @input="
                        () => {
                          formData.representativeQuantity = $formatValue(
                            formData.representativeQuantity
                          );
                        }
                      "
                    />
...
export default {
  ...
  data() {
    return {
      ...
      formDataRules: {
        closureDate: [
          { required: true, message: "请输入闭合日期", trigger: "blur" },
        ],
        unqualifiedProject: [
          {
            required: true,
  ...
  methods: {
    ...
    sure(data) {
      ...
      if (
        !this.formData.closureDate ||
        !this.formData.unqualifiedProject ||
    ...
    closedHandle() {
      ...
      this.$emit("childrenSure", this.dialogShow);
    },
    showPbs() {
