          ...
          <div v-else>
            ...
            >
              ...
              <div class="flex align-center mb-15 justify-start font-14">
                ...
                <div class="content-value">{{ $DictionaryParsing(classs, item.workTime) }}</div>
              </div>
              <div class="flex align-center mb-15 justify-start font-14">
                <div class="content-label">施工标段：</div>
                <div class="content-value">{{ getSelectText(sectionOptions, item.section) }}</div>
              </div>
              <div class="flex align-center mb-15 justify-start font-14">
...
<script>
import { byMonth, remove, logList, sectionList } from './api-v2';
