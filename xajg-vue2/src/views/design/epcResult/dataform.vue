  ...
  <div class="page-leave">
    ...
    <el-row>
      ...
      >
        ...
        <el-col :span="12">
          <el-form-item label="内部审批人" prop="approver">
            <user
...
export default {
  ...
  data() {
    return {
      ...
      formDataRules: {
        ...
        approver: [
          { required: false, message: "请选内部审批人", trigger: "change" },
        ],
        receivingDepartment1: [
  ...
  methods: {
    ...
    async getMyUnitId() {
      ...
      // console.warn("getMyUnitId", userInfo, res)
