    ...
    <el-row>
      ...
      >
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="文件编号:" size="mini" prop="code">
              <el-input
      ...
      <el-row>
        <el-table border :data="tableData">
          ...
          <el-table-column label="操作" prop="name" width="200" align="center">
            <template slot-scope="scope">
              <el-button type="text" @click="handelFilePreview(scope.row)">
                预览
              </el-button>
              <el-button
                @click="handelFileDownload(scope.row)"
                type="text"
                size="small"
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="图纸分发状态:" prop="name">
                <span>{{ getDataStatus(curVersion.drawingStatus) }}</span>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="分发记录:" prop="name">
                <el-link type="primary" @click="openFlowRecord('1', curVersion)"
                  >分发记录</el-link
                >
              </el-form-item>
            </el-col>
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="交底状态:" prop="name">
                <span>{{ getDataStatus(curVersion.explainStatus) }}</span>
              </el-form-item>
            </el-col>
            <el-col :span="12">
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="变更状态:" prop="name">
                <span>{{ getDataStatus(curVersion.changeStatus) }}</span>
              </el-form-item>
            </el-col>
            <el-col :span="12">
    ...
    activeName: {
      handler(newValue) {
        if (this.versions.length > 0) {
          ...
          this.$set(this, "tableData", version.designSupplyFileList);
        } else {
          this.curVersion = {};
          this.tableData = [];
        }
