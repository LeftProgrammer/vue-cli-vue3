...
const route = {
  ...
  children: [
    ...
    {
      path: "statistics",
      component: () => import("@/views/safetyManagement/statistics/index.vue"),
      name: "safeStatistics",
      meta: { title: "隐患管理", auth: "statistics" },
    },
    {
      path: "regime",
      component: () => import("@/views/safetyManagement/regime/index.vue"),
      name: "regime",
    ...
    {
      path: "riskMonitor",
      component: () => import("@/views/safetyManagement/riskMonitor/index.vue"),
      name: "riskMonitor",
    ...
    {
      path: "video",
      component: () => import("@/views/safetyManagement/video/index.vue"),
      name: "safeVideo",
    ...
    {
      path: "vehicleGate",
      component: () => import("@/views/safetyManagement/vehicleGate/index.vue"),
      name: "vehicleGate",
      meta: { title: "车辆闸机管理", auth: "vehicleGate" },
    },
    {
      path: "vehicle",
      component: () => import("@/views/safetyManagement/vehicle/index.vue"),
      name: "vehicle",
    ...
    {
      path: "dangerJob",
      component: () => import("@/views/safetyManagement/dangerJob/index.vue"),
      name: "dangerJob",
    ...
    {
      path: "dust",
      component: () => import("@/views/safetyManagement/dust/index.vue"),
      name: "dust",
      meta: { title: "扬尘监测", auth: "dust" },
    },
    {
      path: "education",
      component: () => import("@/views/safetyManagement/education/index.vue"),
      name: "education",
