...
export function getArchiveFileCatalogueTree() {
  return request({
    url: `/api/archiveFileCatalogueTree/tree`,
    enableThrottle: true,
  });
}
/**
 ...
 * @returns
 */
export function getArchiveFileCatalogueManagerTree() {
  return request({
    url: `/api/archives/file/config/manager/tree`,
    enableThrottle: true,
  });
}
/**
...
export function getArchiveCatalogueTree() {
  return request({
    url: `/api/archives/doc/config/tree`,
    enableThrottle: true,
  });
}
/**
...
export function getArchiveCatalogueManagerTree() {
  return request({
    url: `/api/archives/doc/config/manager/tree`,
    enableThrottle: true,
  });
}
/**
 ...
 * @export axios.request
 */
export function getFileCatalogueTreeDetailed(id, data) {
  return request({
    url: `/api/archives/file/config/tree/${id}`,
    method: "post",
    data,
    enableThrottle: true,
  });
 ...
 * @export axios.request
 */
export function getArchiveCatalogueTreeDetailed(id, data) {
  return request({
    url: `/api/archives/doc/config/tree/${id}`,
    method: "post",
    data,
    enableThrottle: true,
  });
 ...
 * @returns
 */
export function fileCatalogueTreeFindList(data) {
  return request({
    url: `/api/archives/file/config/findList`,
    method: "post",
    data,
    enableThrottle: true,
  });
...
export function archiveCatalogueTreeFindList(data) {
  return request({
    url: `/api/archives/doc/config/findList`,
    method: "post",
    data,
    enableThrottle: true,
  });
 ...
 * @export axios.request
 */
export function saveFileCatalogueTree(data) {
  return request({
    url: `/api/archives/file/config/save`,
    method: "post",
    data,
  });
}
...
export function saveArchiveCatalogueTree(data) {
  return request({
    url: `/api/archives/doc/config/save`,
    method: "post",
    data,
  });
}
 ...
 * @export axios.request
 */
export function deleteFileCatalogueTree(data) {
  return request({
    url: `/api/archives/file/config/delete`,
    method: "post",
    data,
  });
}
...
export function deleteArchiveCatalogueTree(data) {
  return request({
    url: `/api/archives/doc/config/delete`,
    method: "post",
    data,
  });
}
 ...
 * @export axios.request
 */
export function updateFileCatalogueTree(data) {
  return request({
    url: `/api/archives/file/config/update`,
    method: "post",
    data,
  });
}
...
export function updateArchiveCatalogueTree(data) {
  return request({
    url: `/api/archives/doc/config/update`,
    method: "post",
    data,
  });
}
...
export function movedownArchiveFileCatalogueTree(id) {
  return request({
    url: `/api/archiveFileCatalogueTree/move/down/${id}`,
  });
}
/**
...
export function movedownPreArchivingTable(id) {
  return request({
    url: `/api/archives/doc/config/move/down/${id}`,
  });
}
/**
...
export function moveupArchiveFileCatalogueTree(id) {
  return request({
    url: `/api/archiveFileCatalogueTree/move/up/${id}`,
    enableThrottle: true,
  });
}
/**
...
export function moveupPreArchivingTable(id) {
  return request({
    url: `/api/archives/doc/config/move/up/${id}`,
  });
}
/**
 * 通过工程标识和目录ID查询文档分页数据
 * @export axios.request
 */
export function getSelectCommonFileList(data) {
  return request({
    url: `/api/catalogue/page`,
    method: "post",
    data,
    enableThrottle: true,
  });
 ...
 * @export axios.request
 */
export function deleteCommonFile(id) {
  return request({
    url: `/api/catalogue/delete/${id}`,
    method: "get",
  });
}
/**
...
export function deleteArchiveFile(id) {
  return request({
    url: `/api/archives/collect/delete/${id}`,
    method: "get",
  });
}
/**
 ...
 * @export axios.request
 */
export function saveArchiveFile(data) {
  return request({
    url: `/api/archives/collect/save`,
    method: "post",
    data,
  });
}
...
export function updateArchiveFile(data) {
  return request({
    url: `/api/archives/collect/update`,
    method: "post",
    data,
  });
}
 ...
 * @export axios.request
 */
export function getCommonFileDetail(params) {
  return request({
    url: `/api/catalogue/get`,
    params,
    enableThrottle: true,
  });
}
...
export function addFileAttachment(id, data) {
  return request({
    url: `/api/archiveFileStore/addFileAttachment/${id}`,
    method: "post",
    data,
  });
}
 ...
 * @returns
 */
export function movedownFileTable(id) {
  return request({
    url: `/api/archives/file/config/move/down/${id}`,
  });
}
/**
 * 文件上移
 ...
 * @returns
 */
export function moveupFileTable(id) {
  return request({
    url: `/api/archives/file/config/move/up/${id}`,
  });
}
/**
 * 文件鉴定
