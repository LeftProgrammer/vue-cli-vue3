<template>
  <div id="MarkPage" class="shared-mark" v-show="markPageState" style="z-index: 100;">
    ...
    <div class="markBtnBox" :style="{right:'0px'}">
      <div class="shrink-box" :class="[editSelect?'shrink-openshrink-open':'shrink-hide']">
        <span @click="ShrinkChange" class="shrink-change">
          <img v-if="editSelect" src="../../../assets/img/bim/mark/extend.png" alt="" />
          <img v-else src="../../../assets/img/bim/mark/shrink.png" alt="" />
        </span>
    ...
    <div class="footer-btn">
      <div @click="SortClick('downLoad')" class="btn-tool">
        <el-tooltip title="保存">
          <img src="../../../assets/img/bim/mark/SaveBtn_1.png" />
        </el-tooltip>
      </div>
      <div @click="SortClickNew('cancel',-1)" class="btn-tool">
        <el-tooltip title="关闭">
          <img src="../../../assets/img/bim/mark/Close.png" />
        </el-tooltip>
      </div>
    </div>
    <!-- <div class="sort-btn hidden-xs">
        <a-space :size="5">
            <a-button v-for="value,index in SortSelect" :key="index" type="primary" @click="SortClick(value.name,index)" class="btn-tool" :class="[activeIndex === index ?'edit-btn-select':'edit-btn-noselect']">
                <div v-if="value.name == 'strokeColorBox'">
                    <colorPicker v-model="selectColor" id="colorPick" @change="ChangeColor"></colorPicker>
                    <img :src="activeIndex === index?value.img1: value.img" :title="value.title" />
                </div>
            ...
            <a-button type="primary" @click="SortClickNew('fillDraw',-1)" class="btn-tool" :class="[initData.isFill ?'edit-btn-select':'edit-btn-noselect']">
                <img :src="initData.isFill? require('../../../assets/img/bim/mark/FillBtn_1.png'): require('../../../assets/img/bim/mark/FillBtn.png')" title="填充" />
            </a-button>
            <a-button type="primary" @click="SortClickNew('cancel',-1)" class="btn-tool">
                <img src="../../../assets/img/bim/mark/Close.png" title="关闭" />
            </a-button>
        </a-space>
    </div> -->
  </div>
...
const DrawSelect = [
    {
        ...
        nameNum: '1',
        title: '矩形',
        img: require('../../../assets/img/bim/mark/DrawRectangle.png'),
        img1: require('../../../assets/img/bim/mark/DrawRectangle_1.png'),
    },
    // {
    //     name: 'delta',
    //     nameNum: '1',
    //     title: '三角',
    //     img: require('../../../assets/img/bim/mark/DrawTriangle.png'),
    //     img1: require('../../../assets/img/bim/mark/DrawTriangle_1.png'),
    // },
    {
        name: 'arrow',
        nameNum: '1',
    ...
    //     nameNum: '1',
    //     title: '圆形',
    //     img: require('../../../assets/img/bim/mark/DrawCircle.png'),
    //     img1: require('../../../assets/img/bim/mark/DrawCircle_1.png'),
    // },
    {
        name: 'ellipse',
        nameNum: '1',
    ...
    //     nameNum: '1',
    //     title: '直线',
    //     img: require('../../../assets/img/bim/mark/DrawLine.png'),
    //     img1: require('../../../assets/img/bim/mark/DrawLine_1.png'),
    // },
    // {
    //     name: 'polygon',
    //     nameNum: '1',
    //     title: '多边形',
    //     img: require('../../../assets/img/bim/mark/DrawPolygon.png'),
    //     img1: require('../../../assets/img/bim/mark/DrawPolygon_1.png'),
    // },
    {
        name: 'font',
        nameNum: '1',
        title: '文字',
        img: require('../../../assets/img/bim/mark/DrawText.png'),
        img1: require('../../../assets/img/bim/mark/DrawText_1.png'),
    },
    // {
    //     name: 'signet',
    //     nameNum: '1',
    //     title: '印章',
    //     img: require('../../../assets/img/bim/mark/DrawSeal.png'),
    //     img1: require('../../../assets/img/bim/mark/DrawSeal_1.png'),
    // },
    {
        name: 'pen',
        nameNum: '1',
        title: '铅笔',
        img: require('../../../assets/img/bim/mark/DrawPencil.png'),
        img1: require('../../../assets/img/bim/mark/DrawPencil_1.png'),
    },
    {
        name: 'strokeColorBox',
        nameNum: '1',
    ...
    },
    {
      ...
      nameNum: '1',
      title: '撤销',
      img: require('../../../assets/img/bim/mark/return_0.png'),
      img1: require('../../../assets/img/bim/mark/return.png'),
    },
    // {
    //     name: 'eraser',
    //     nameNum: '1',
    //     title: '橡皮',
    //     img: require('../../../assets/img/bim/mark/DrawRubber.png'),
    //     img1: require('../../../assets/img/bim/mark/DrawRubber_1.png'),
    // },
]
const SortSelect = [
    // {
    ...
    //     nameNum: '1',
    //     title: '绘制',
    //     img: require('../../../assets/img/bim/mark/EditorBtn.png'),
    //     img1: require('../../../assets/img/bim/mark/EditorBtn_1.png'),
    // },
    // {
    //     name: 'move',
    //     nameNum: '1',
    //     title: '平移',
    //     img: require('../../../assets/img/bim/mark/TranslationBtn.png'),
    //     img1: require('../../../assets/img/bim/mark/TranslationBtn_1.png'),
    // },
    // {
    //     name: 'remote',
    //     nameNum: '1',
    //     title: '删除',
    //     img: require('../../../assets/img/bim/mark/DeleteBtn.png'),
    //     img1: require('../../../assets/img/bim/mark/DeleteBtn_1.png'),
    // },
    // {
    //     name: 'strokeColorBox',
    //     nameNum: '1',
    ...
    //   nameNum: "1",
    //   title: '填充',
    //   img: require("../../../assets/img/bim/mark/FillBtn.png"),
    //   img1: require("../../../assets/img/bim/mark/FillBtn_1.png"),
    // },
    {
        name: 'downLoad',
        nameNum: '1',
        title: '保存',
        img: require('../../../assets/img/bim/mark/SaveBtn.png'),
        img1: require('../../../assets/img/bim/mark/SaveBtn_1.png'),
    },
    // {
    //   name: "cancel",
    //   nameNum: "1",
    //   title: '取消',
    //   img: require("../../../assets/img/bim/mark/Close.png"),
    //   img1: require("../../../assets/img/bim/mark/Close.png"),
    // }
]
export default {
    data() {
    ...
    methods: {
        OpenStatusMonitoring() {
          ...
          this.markPageState = true
          this.initMark()
        },
        initMark() {
            const that = this
            const sceneElement = document.getElementById('cesiumContainer') //场景元素
            const sceneElementSize = sceneElement.getBoundingClientRect() //场景元素大小
            const sceneCanvas = sceneElement.getElementsByClassName('cesium-viewer')[0].getElementsByTagName('canvas')
            that.viewpointPictureData.cameraData = window.api.Camera.GetCamera() //当前视点
            ...
            that.initData.canvasWidth = sceneElementSize.width
            that.initData.canvasHeight = sceneElementSize.height
            that.canvasLeft = sceneElementSize.left
            that.canvasTop = sceneElementSize.top
            ...
            const img = new Image()
            img.src = sceneCanvas[0].toDataURL() //截图
            img.onload = function () {
        ...
        DrawClick(name, nameNum, index) {
            ...
            if (name == 'strokeColorBox') {
              ...
              console.log(this.initData.drawHistoryArrData)
        ...
        drawTypeArr: function (arr, j) {
            ...
            var drawTypeFn = {
                ...
                circle: function () {
                    ...
                    that.initData.context2d.lineWidth = arr[j].size //设置线宽状态
                    that.initData.context2d.strokeStyle = arr[j].color
                    that.initData.context2d.arc(
                        arr[j].x + (arr[j].toX - arr[j].x) / 2,
                        arr[j].y + (arr[j].toY - arr[j].y) / 2,
                        (arr[j].toX - arr[j].x) / 2,
                        0,
                        2 * Math.PI
                    )
