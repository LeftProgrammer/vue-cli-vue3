...
const mutations = {
  ADD_VISITED_VIEW: (state, view) => {
    // console.log("ADD_VISITED_VIEW", view, state.visitedViews);
    // let _view = state.visitedViews.some((v) => v.path === view.path);
    // let hasview = state.visitedViews.some((v) => v.fullPath === view.fullPath);
